  ...
  readonly reportOptions: ReportOption[] = [
    {
      ...
      icon: 'picture_as_pdf',
      filename: (subjectId) => `grades-report-subject-${subjectId}.pdf`,
      endpoint: (subjectId) => `/reports/subjects/${subjectId}/grades-report/pdf`,
    ...
    },
    {
      ...
      description: 'Genera y descarga el reporte oficial de asistencia y faltas en Excel.',
      icon: 'table_chart',
      filename: (subjectId) => `attendance-report-subject-${subjectId}.xlsx`,
      endpoint: (subjectId) => `/reports/subjects/${subjectId}/attendance/excel`,
